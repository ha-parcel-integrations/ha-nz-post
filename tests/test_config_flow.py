"""Tests for the NZ Post config and options flow."""

from pytest_homeassistant_custom_component.common import MockConfigEntry

from custom_components.nz_post.config_flow import (
...
def test_valid_tracking_code_is_deliberately_broad():
    assert valid_tracking_code("EXAMPLE123456")
    assert valid_tracking_code("ABC")
    assert valid_tracking_code("UPU-RA123456789NZ")
