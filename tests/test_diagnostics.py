"""Tests for NZ Post diagnostics."""
from datetime import timedelta
from unittest.mock import MagicMock

from custom_components.nz_post.diagnostics import (
...
async def test_diagnostics_redacts_and_counts(hass):
    ...
    entry.runtime_data.coordinator.data = [
        {
            ...
            "raw": {
                "tracking_reference": "EXAMPLE123456",
                "signed_by": "Jane Doe",
                "depot_name": "Private depot",
            },
        }
    ]
    ...
    assert result["incoming"][0]["raw"]["tracking_reference"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["signed_by"] == "**REDACTED**"
    assert result["incoming"][0]["raw"]["depot_name"] == "**REDACTED**"
